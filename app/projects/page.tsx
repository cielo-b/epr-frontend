        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex flex-1 items-center gap-3">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-green-600 transition-all text-sm"
                value={search}
                onChange={(e) => setSearch(e.target.value)}
              />
            </div>
            <select
              className="px-4 py-2 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-green-600 transition-all text-sm font-medium text-gray-700"
              value={filterStatus}
          ...
          {canCreateProjects(user.role) && (
            <button
              ...
              className="px-6 py-2 bg-brand-green-600 text-white rounded-xl hover:bg-brand-green-700 transition-all shadow-lg shadow-brand-green-600/20 flex items-center gap-2 font-bold active:scale-95 shrink-0"
            >
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Health</th>
                ...
                <tr key={project.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500 line-clamp-1 max-w-[200px]">{project.description}</span>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-full bg-brand-green-50 flex items-center justify-center text-brand-green-700 font-bold text-xs capitalize">
